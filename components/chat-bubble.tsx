...
export function ChatBubble({ message, isUser }: ChatBubbleProps) {
  return (
      <>
        {
          isUser ? (
              <article className="flex w-max max-w-[75%] rounded-lg px-3 py-2 text-sm ml-auto bg-primary text-primary-foreground">{ message }</article>
                                  ...
                                  <div className="flex max-w-full flex-col flex-grow">
                                      <div className="min-h-8 text-message flex w-full flex-col items-end gap-2 whitespace-normal break-words text-start"
                                          ...
                                          <div className="flex w-full flex-col gap-1 empty:hidden first:pt-[3px]">
                                              <div
                                                  className="markdown prose w-full break-words dark:prose-invert dark">{message}</div>
                                          </div>
                                      </div>
                                  </div>
...
function ChatGPTAvatar() {
  return (
      <svg width="41" height="41" viewBox="0 0 41 41" fill="none"
           xmlns="http://www.w3.org/2000/svg" className="icon-md" role="img">
