  ...
  return (
    <div className="flex flex-col items-center gap-5 justify-center h-[70vh]">
      ...
      <p className="sm:w-[75%] mx-auto text-center text-muted-foreground ">
        ...
        looking for quick answers, creative ideas, or in-depth explanations,
        ChatGPT is here to help. Powered by advanced AI, it understands your
        questions, responds with contextually relevant information, and can even
        adapt to your tone and style.
      </p>
    </div>
  );
}
